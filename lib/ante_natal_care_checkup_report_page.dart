  ...
  void _deleteRecord(String docId) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(tr('Are you sure you want to delete this ANC checkup record?')),
        actions: [
          TextButton(
      ...
      builder: (context) => Scaffold(
        appBar: AppBar(
          title: _isSearchingActive
              ...
              : Text(tr('ANC Checkup Report'), style: const TextStyle(fontWeight: FontWeight.bold)),
          centerTitle: true,
        elevation: 0,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      columns: [
                        ...
                        DataColumn(label: Text(tr('Sync'), style: const TextStyle(fontWeight: FontWeight.bold))),
